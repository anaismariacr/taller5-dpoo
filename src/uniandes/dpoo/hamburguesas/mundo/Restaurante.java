...
public class Restaurante
{
    ...
    public void cerrarYGuardarPedido( ) throws NoHayPedidoEnCursoException, IOException
    {
        ...
        String nombreArchivo = getPrefijoFacturas() + pedidoEnCurso.getIdPedido( ) + ".txt";
        pedidoEnCurso.guardarFactura( new File( getCarpetaFacturas() + nombreArchivo ) );
        pedidoEnCurso = null;
    }
